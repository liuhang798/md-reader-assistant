...
const translations = {
  'zh-CN': {
    ...
    aboutVersion: '版本 2.3.11', aboutDescription: '一款专注、美观、跨平台的 Markdown 阅读与编辑工具，支持实时预览、语法高亮、目录导航、最近阅读和文档收藏。',
  ...
  en: {
    ...
    aboutVersion: 'Version 2.3.11', aboutDescription: 'A focused, beautiful, cross-platform Markdown reader and editor with live preview, syntax highlighting, navigation, recent reading, and document favorites.',
...
function openUpdateDialog(info) {
  ...
  $('#currentVersion').textContent = info.currentVersion || '2.3.11';
