...
window.quilliteMarkdown = {
  ...
  getFeedbackSystemInfo: () => desktopRuntime ? Backend.GetFeedbackSystemInfo() : resolved({ appVersion: '2.4.7', os: browserPlatform === 'darwin' ? 'macos' : 'windows', systemVersion: navigator.userAgent }),
  ...
  checkForUpdates: force => desktopRuntime
    ...
    : resolved(mockUpdate
      ? {
          ...
          latestVersion: '2.4.7',
          releaseName: localStorage.getItem('language') === 'en' ? 'Quillite Markdown 2.4.7' : '轻阅 Markdown 2.4.7',
      ...
      : { checked: true, available: false, currentVersion: '2.4.7', latestVersion: '2.4.7' }),
