...
func TestPickUpdateAsset(t *testing.T) {
	assets := []githubReleaseAsset{
		{Name: "md-reader-assistant-2.3.9-linux-amd64.deb"},
		{Name: "md-reader-assistant-2.3.9-macos-universal.dmg"},
		{Name: "md-reader-assistant-2.3.9-macos-universal.bin"},
		{Name: "md-reader-assistant-2.3.9-windows-amd64.exe"},
		{Name: "md-reader-assistant-2.3.9-windows-amd64.bin"},
	}
	...
	if darwin.Name != "md-reader-assistant-2.3.9-macos-universal.bin" {
	...
	if windows.Name != "md-reader-assistant-2.3.9-windows-amd64.bin" {
